...
class AppTheme {
  ...
  static final ThemeData lightTeme = ThemeData.light().copyWith(
    ...
    textTheme: const TextTheme(
      ...
      headlineMedium: TextStyle(
          fontWeight: FontWeight.bold, fontSize: 26, color: AppColors.lightSec),
      headlineLarge: TextStyle(
          fontWeight: FontWeight.bold, fontSize: 32, color: AppColors.lightSec),
    ),
  ...
  static final ThemeData darkTheme = ThemeData.dark().copyWith(
    ...
    textTheme: const TextTheme(
      ...
      headlineMedium: TextStyle(
          fontWeight: FontWeight.bold, fontSize: 26, color: AppColors.darkSec),
      headlineLarge: TextStyle(
          fontWeight: FontWeight.bold, fontSize: 32, color: AppColors.darkSec),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
